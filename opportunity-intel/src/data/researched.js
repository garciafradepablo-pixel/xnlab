...
export const RESEARCHED = [
  ...
  mkReal({
    ...
    whyNow: "A large new flagship opened recently — filling covers and private events is an immediate revenue lever.",
  ...
  mkReal({
    ...
    whyNow: "Multi-city expansion plus an international jump to Lisbon — the moment to lock brand consistency before more openings.",
