...
export const RESEARCHED = [
  ...
  mkReal({
    ...
    evidence: [
      ...
      ev("reachableDecisionMaker", "press", "Emprendedores", "Cofundadores identificados: Pablo Nueno y Pedro Luis González; estrategia omnicanal (Serie A en 2025).", 2, "https://emprendedores.es/casos-de-exito/lista-emprendedores/las-mejores-startups-de-salud-de-2025/"),
  ...
  // ── Tercera tanda (hacia el Top 20) — verificados 2026-05-29 ──────────────
  mkReal({
    id: "r-rever",
    company: "Rever",
    sector: "growth",
    subsector: "SaaS de gestión de devoluciones para ecommerce",
    city: "Barcelona",
    region: "Cataluña",
    website: null,
    instagram: null,
    linkedin: "company/rever-returns",
    googleMaps: null,
    phone: null,
    email: null,
    dm: { name: "Oriol Hernández i Fajula", role: "Co-fundador / CEO", linkedin: null },
    // transición G, econ G, tensión Y, palanca Y, dolor X, whyNow G,
    // decisor G, presupuesto Y, encaje G, brutal G
    S: "GGYYXGGYGG",
    offer: "xn_transformation",
    researchedAt: "2026-05-29",
    sources: ["https://emprendedores.es/startups/startups-serie-a/"],
    evidence: [
      ev("transitionSignal", "funding", "Emprendedores", "Cerró Serie A de 7,5 M€ (sep 2025) liderada por 13books Capital, con JME, Big Sur y Bynd; revoluciona la gestión de devoluciones en ecommerce.", 3, "https://emprendedores.es/startups/startups-serie-a/"),
      ev("economicCapacity", "funding", "Emprendedores", "7,5 M€ levantados — capacidad alta para invertir en marca y crecimiento.", 3, "https://emprendedores.es/startups/startups-serie-a/"),
      ev("whyNow", "funding", "Emprendedores", "Ronda recién cerrada (sep 2025) — despliegue de capital y escalado comercial ahora.", 2, "https://emprendedores.es/startups/startups-serie-a/"),
      ev("reachableDecisionMaker", "press", "Emprendedores", "Cofundadores identificados: Oriol Hernández i Fajula y Màrius Montmany.", 2, "https://emprendedores.es/startups/startups-serie-a/"),
      ev("strategicFit", "inference", "Análisis", "SaaS B2B en escalado post-ronda = encaje claro de posicionamiento + web/funnel.", 2, "https://emprendedores.es/startups/startups-serie-a/"),
    ],
    tensions: ["growth_structure", "ambition_maturity", "visibility_conversion"],
    thesis: "This company is likely scaling commercial motion on a €7.5M round faster than it has solidified (verify) the positioning and B2B funnel that growth needs.",
    summary: "Rever, SaaS de devoluciones para ecommerce, cerró Serie A de 7,5 M€ (sep 2025) con cofundadores identificados. Financiación, capacidad y decisor verificados; el posicionamiento y el funnel B2B para escalar es la palanca a confirmar.",
    whyNow: "Serie A recién cerrada — el capital se despliega ahora en crecimiento comercial.",
    whyBeforeOthers: "Financiación fuerte, cofundador con nombre y mandato B2B — encaje XN/01 sólido.",
    blindSpot: "Escalar ventas sin un posicionamiento afilado quema ronda en adquisición ineficiente.",
    firstLever: "Contactar a Oriol Hernández; posicionamiento + funnel B2B para el escalado post-ronda.",
    callOpening: "Oriol, enhorabuena por la Serie A. Antes de pisar el acelerador comercial, ¿el posicionamiento y el funnel B2B están listos para escalar o se va resolviendo sobre la marcha?",
    objection: "Tenemos equipo de growth interno.",
    objectionResponse: "Perfecto, y rinde más sobre un posicionamiento claro. Montamos la base, vuestro equipo ejecuta más rápido.",
    reasonsNotToCall: ["VCs pueden imponer agencia.", "Ancho de banda del fundador post-ronda.", "Web/contacto directo sin confirmar."],
    invalidators: ["Ya tienen estudio de marca contratado.", "Posicionamiento B2B ya consolidado."],
  }),
  ...
  mkReal({
    ...
    company: "Hoff",
    sector: "growth",
    subsector: "Marca de calzado / moda (expansión internacional)",
    city: "Valencia",
    region: "Comunidad Valenciana",
    website: "https://hoff.es/",
    instagram: "@hoff",
    linkedin: "company/hoff-brand",
    googleMaps: null,
    phone: null,
    email: null,
    dm: { name: null, role: "Dirección (por identificar)", linkedin: null },
    // transición G, econ G, tensión Y, palanca Y, dolor X, whyNow G,
    // decisor X, presupuesto Y, encaje G, brutal Y
    S: "GGYYXGXYGY",
    offer: "xn_transformation",
    researchedAt: "2026-05-29",
    sources: ["https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"],
    evidence: [
      ev("transitionSignal", "press", "Modaes", "Abrió su capital a Rahco Capital y un family office para profesionalizarse y apoyar la expansión internacional; +50 puntos de venta en 45 países, 250 empleados.", 3, "https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"),
      ev("economicCapacity", "press", "Modaes", "Red de +50 puntos de venta en 45 países y entrada de capital riesgo — capacidad alta.", 3, "https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"),
      ev("whyNow", "press", "Modaes", "Entrada de inversor + plan de expansión internacional en marcha — momento de profesionalizar marca.", 2, "https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"),
      ev("strategicFit", "inference", "Análisis", "Marca de moda con ambición global = caso de marca premium muy atractivo para XN.", 2, "https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"),
    ],
    tensions: ["ambition_maturity", "expansion_systems", "visibility_conversion"],
    thesis: "This company is likely outgrowing its brand system because it has not yet solved (verify) the worldbuilding and digital experience a 45-country expansion demands.",
    summary: "Hoff, marca de calzado fundada en 2017, abrió su capital para profesionalizarse y crecer internacionalmente (+50 puntos en 45 países). Transición, capacidad y ambición verificadas; falta identificar al decisor y confirmar la madurez del sistema de marca para el salto global.",
    whyNow: "Entrada de capital + plan de expansión internacional activo — momento de profesionalizar la marca.",
    whyBeforeOthers: "Marca global en profesionalización con respaldo de inversión — encaje XN de primer nivel; decisor por identificar lo modera.",
    blindSpot: "Crecer a 45 países sin un sistema de marca sólido fragmenta la identidad por mercado.",
    firstLever: "Identificar dirección; brand worldbuilding + experiencia digital para la expansión internacional.",
    callOpening: "Con la marca ya en 45 países y la entrada de capital, la consistencia global es clave. ¿El sistema de marca está listo para sostener ese salto o se adapta país a país?",
    objection: "Tenemos equipo creativo y de retail propio.",
    objectionResponse: "Justo por eso: a escala global, ese equipo necesita un sistema de marca que unifique, no que improvise por mercado. Ahí entramos.",
    reasonsNotToCall: ["Marca consolidada, posible equipo interno fuerte.", "Inversor puede tener agencia.", "Decisor sin identificar."],
    invalidators: ["Ya tienen un sistema de marca global consolidado.", "Hay agencia contratada para la expansión."],
  }),
  ...
  mkReal({
    ...
    company: "Eme Studios",
    sector: "growth",
    subsector: "Marca de moda (apertura de retail físico)",
    city: "Barcelona",
    region: "Cataluña",
    website: "https://emestudios.com/",
    instagram: "@eme.studios",
    linkedin: null,
    googleMaps: null,
    phone: null,
    email: null,
    dm: { name: null, role: "Fundadoras (por identificar)", linkedin: null },
    // transición G, econ Y, tensión Y, palanca Y, dolor X, whyNow G,
    // decisor X, presupuesto Y, encaje G, brutal Y
    S: "GYYYXGXYGY",
    offer: "reposition",
    researchedAt: "2026-05-29",
    sources: ["https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"],
    evidence: [
      ev("transitionSignal", "press", "Modaes", "Abrió recientemente una nueva tienda en Barcelona y prevé una tercera en Valencia — salto a retail físico.", 3, "https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"),
      ev("whyNow", "press", "Modaes", "Apertura reciente en Barcelona + tercera prevista en Valencia — expansión retail activa.", 3, "https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"),
      ev("economicCapacity", "press", "Modaes", "Start-up de moda en crecimiento que abre retail propio — capacidad moderada en expansión.", 2, "https://www.modaes.com/back-stage/expansion-profesionalizacion-y-retail-las-start-ups-de-moda-en-espana-se-hacen-mayores"),
    ],
    tensions: ["expansion_systems", "quality_perception", "visibility_conversion"],
    thesis: "This company is likely jumping to physical retail without (verify) a unified brand-space and omnichannel experience to carry it.",
    summary: "Eme Studios, marca de moda, abrió tienda en Barcelona y prepara una tercera en Valencia. Expansión a retail físico y timing verificados; capacidad moderada y decisor por identificar. Buen encaje 01 de reposicionamiento + experiencia de marca.",
    whyNow: "Apertura reciente en Barcelona y tercera prevista en Valencia — la atmósfera de marca en retail importa ahora.",
    whyBeforeOthers: "Salto a físico claro y reciente; capacidad y decisor a confirmar lo sitúan en banda media.",
    blindSpot: "El salto DTC→retail físico exige una atmósfera de marca que no siempre se traslada sola.",
    firstLever: "Identificar a las fundadoras; atmósfera de marca + experiencia retail/omnicanal.",
    callOpening: "Enhorabuena por la tienda de Barcelona y la próxima de Valencia. El salto a físico se juega en la atmósfera de marca — ¿la tenéis definida para cada tienda nueva?",
    objection: "Lo llevamos internamente.",
    objectionResponse: "Genial para el día a día; la atmósfera de marca en retail es donde se gana la percepción premium. Os enseño dónde reforzarla.",
    reasonsNotToCall: ["Marca pequeña, presupuesto ajustado.", "Decisor sin identificar."],
    invalidators: ["Ya tienen una experiencia de marca retail definida.", "La tercera tienda está pausada."],
  }),
  ...
  mkReal({
    ...
    company: "MAEX",
    sector: "health",
    subsector: "Clínicas dentales altamente especializadas (en expansión)",
    city: "Madrid",
    region: "Madrid",
    website: null,
    instagram: "@maex.clinicas",
    linkedin: "company/maex",
    googleMaps: null,
    phone: null,
    email: null,
    dm: { name: null, role: "Dirección (por identificar)", linkedin: null },
    // transición G, econ G, tensión Y, palanca Y, dolor X, whyNow G,
    // decisor X, presupuesto Y, encaje Y, brutal Y
    S: "GGYYXGXYYY",
    offer: "web_funnel",
    researchedAt: "2026-05-29",
    sources: ["https://www.eldentistamoderno.com/texto-diario/mostrar/5879394/donte-group-supera-427-millones-2025-avanza-hacia-600-clinicas-2030"],
    evidence: [
      ev("transitionSignal", "press", "El Dentista Moderno", "MAEX alcanzó las 18 clínicas altamente especializadas, casi triplicando su actividad respecto al año anterior.", 3, "https://www.eldentistamoderno.com/texto-diario/mostrar/5879394/donte-group-supera-427-millones-2025-avanza-hacia-600-clinicas-2030"),
      ev("economicCapacity", "press", "El Dentista Moderno", "18 clínicas especializadas y crecimiento acelerado — capacidad de inversión alta.", 2, "https://www.eldentistamoderno.com/texto-diario/mostrar/5879394/donte-group-supera-427-millones-2025-avanza-hacia-600-clinicas-2030"),
      ev("whyNow", "press", "El Dentista Moderno", "Triplicó actividad en un año — fase de expansión intensa que necesita captación consistente ahora.", 3, "https://www.eldentistamoderno.com/texto-diario/mostrar/5879394/donte-group-supera-427-millones-2025-avanza-hacia-600-clinicas-2030"),
    ],
    tensions: ["growth_structure", "expansion_systems", "visibility_conversion"],
    thesis: "This company is likely under-supporting a 3x expansion because it has not yet solved (verify) a replicable patient-acquisition system across its specialised clinics.",
    summary: "MAEX casi triplicó actividad hasta 18 clínicas dentales especializadas. Expansión y capacidad verificadas; falta identificar al decisor y confirmar la captación de pacientes replicable a ese ritmo de crecimiento.",
    whyNow: "Triplicó actividad en un año — la captación de pacientes replicable se tensiona justo ahora.",
    whyBeforeOthers: "Crecimiento muy fuerte en salud (objetivo del brief); decisor por identificar lo modera.",
    blindSpot: "Triplicar clínicas sin un sistema de captación replicable deja ingresos sobre la mesa en cada apertura.",
    firstLever: "Identificar dirección; sistema de captación de pacientes replicable entre clínicas.",
    callOpening: "Triplicar hasta 18 clínicas en un año es un ritmo enorme. ¿Tenéis un sistema de captación de pacientes replicable para que cada clínica nueva arranque a tope?",
    objection: "Tenemos marketing centralizado.",
    objectionResponse: "A ese ritmo, el equipo necesita un sistema replicable, no improvisar por clínica. Os enseño dónde se pierde captación.",
    reasonsNotToCall: ["Grupo con marketing interno.", "Decisor sin identificar.", "Posible agencia ya contratada."],
    invalidators: ["Ya operan captación replicable entre clínicas.", "Equipo interno cubre la expansión."],
  }),
  ...
  mkReal({
    ...
    company: "DR. INUK",
    sector: "health",
    subsector: "Estética dental / healthtech de consumo",
    city: "Madrid",
    region: "Madrid",
    website: "https://drinuk.com/",
    instagram: "@dr.inuk",
    linkedin: "company/dr-inuk",
    googleMaps: null,
    phone: null,
    email: null,
    dm: { name: null, role: "Fundador (por identificar)", linkedin: null },
    // transición G, econ Y, tensión Y, palanca Y, dolor X, whyNow Y,
    // decisor X, presupuesto Y, encaje G, brutal Y
    S: "GYYYXYXYGY",
    offer: "reposition",
    researchedAt: "2026-05-29",
    sources: ["https://emprendedores.es/startups/empresa-estetica-dental-dr-inuk/"],
    evidence: [
      ev("transitionSignal", "press", "Emprendedores", "Empresa que quiere democratizar la estética dental — modelo de consumo escalable (healthtech dental).", 2, "https://emprendedores.es/startups/empresa-estetica-dental-dr-inuk/"),
      ev("economicCapacity", "press", "Emprendedores", "Modelo de estética dental de consumo escalable — margen y crecimiento.", 2, "https://emprendedores.es/startups/empresa-estetica-dental-dr-inuk/"),
      ev("strategicFit", "inference", "Análisis", "Marca de consumo en salud con ángulo democratizador = caso de marca atractivo.", 2, "https://emprendedores.es/startups/empresa-estetica-dental-dr-inuk/"),
    ],
    tensions: ["ambition_maturity", "visibility_conversion", "quality_perception"],
    thesis: "This company is likely under-building the brand that a consumer-scale dental-aesthetics play needs, because it has not yet solved (verify) positioning and conversion.",
    summary: "DR. INUK quiere democratizar la estética dental con un modelo de consumo escalable. Ángulo y encaje verificados por prensa; capacidad, timing y decisor aún por confirmar — lead de salud/consumo a enriquecer.",
    whyNow: "Modelo de consumo en fase de crecimiento; conviene confirmar un gatillo concreto (ronda/apertura) al enriquecer.",
    whyBeforeOthers: "Encaje de marca atractivo en salud-consumo; varias señales por confirmar lo dejan en banda media.",
    blindSpot: "Un modelo de consumo en salud vive o muere por marca y conversión, no solo por el tratamiento.",
    firstLever: "Identificar al fundador; posicionamiento de marca de consumo + conversión.",
    callOpening: "Democratizar la estética dental es un posicionamiento potente. ¿La marca y la conversión online están a la altura de esa ambición de consumo?",
    objection: "Estamos centrados en producto y operativa.",
    objectionResponse: "Exacto — y en consumo, la marca es la que escala el producto. Os enseño dónde se pierde conversión hoy.",
    reasonsNotToCall: ["Señales por confirmar (capacidad, timing).", "Decisor sin identificar.", "Posible fase muy temprana."],
    invalidators: ["Cierran una ronda o aceleran (re-cualifica al alza).", "Ya tienen marca/conversión resueltas."],
  }),
];
